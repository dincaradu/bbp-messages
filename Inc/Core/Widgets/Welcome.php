...
class Welcome extends \WP_Widget
{
    public function __construct() {
        parent::__construct(
            'bbPMWelcome', 
            __('bbPM Welcome', BBP_MESSAGES_DOMAIN), 
            array(
                'description' => __('Widget with user welcoming note, messages links with unread counts, and a logout link', BBP_MESSAGES_DOMAIN)
            ) 
        );
    }
